...
class SystemAdminDeveloper extends Component {
  componentDidMount() {
    this.props.getSysAdminDevelopers()
...
export default connect(mapStateToProps, { getSysAdminDevelopers })(SystemAdminDeveloper)