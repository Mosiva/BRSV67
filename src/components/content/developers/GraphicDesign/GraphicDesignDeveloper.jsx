...
import { getGrahpDevelopers } from '../../../../redux/redux-store/developers-reducer'
...
class GraphicDesignDeveloper extends Component {
  componentDidMount() {
    this.props.getGrahpDevelopers()
...
export default connect(mapStateToProps, { getGrahpDevelopers })(GraphicDesignDeveloper)